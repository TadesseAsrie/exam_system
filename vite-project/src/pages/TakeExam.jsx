...
const TakeExam = () => {
  ...
  const { currentExam, currentQuestions, userAnswers, saveAnswer, submitExam } =
    useExam();
  ...
  useEffect(() => {
    const isCompleted =
      localStorage.getItem(`exam_${examId}_completed`) === "true";
    if (isCompleted) {
  ...
  const selected = userAnswers[currentQuestion.id] || null;
          ...
          <div className="glass-card rounded-2xl p-6 max-w-md w-full shadow-2xl transform transition-all animate-slide-up">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 text-sm text-gray-500">
                <p>
                  Answered: {answeredCount} of {currentQuestions.length}{" "}
                  questions
                </p>
                <p>
                  Unanswered: {currentQuestions.length - answeredCount}{" "}
                  questions
                </p>
              </div>
            </div>
