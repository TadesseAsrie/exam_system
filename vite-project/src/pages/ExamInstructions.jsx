...
//     setIsLoading(false);
//   }, [examId, loadExam, navigate, addToast]);
...
//   const handleStartExam = () => {
//     if (isCompleted) {
//       addToast("This exam has already been completed", "error");
//       return;
//     }
//     navigate(`/exam/${examId}/take`);
//   };
...
//         {isCompleted && (
//           <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-700 rounded-xl flex items-center gap-3">
...
//             }`}
//           >
//             {isCompleted ? <FiLock /> : <FiPlay />}
//             {isCompleted ? "Locked" : "Start Examination"}
//           </button>
//         </div>
//       </div>
//     </div>
